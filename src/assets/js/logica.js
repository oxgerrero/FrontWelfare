...
function logicaNegocio(url, param) {
    ...
    if( url != "src/componentes/inicio.html" &&
        url != "src/componentes/cambioclave.html" &&
    ...
    switch (url) {
        case 'src/componentes/inicio.html':
            break;
        case 'src/componentes/cambioclave.html':
            break;
        //roles
        ...
        case 'src/componentes/estado/estadoadmin.html':
            ...
            break;
            //Asistencia
            case 'src/componentes/asistencia/asistenciacrear.html':
                llenarSelecTipoAsistencia();
                llenarSelecUsuariosAsistencia();
                llenarSelecRestauranteAsistencia();
            break;
            case 'src/componentes/asistencia/asistencialistado.html':
                obtenerTodosAsistenciaL();
                break;
        //pagos
        ...
        case 'src/componentes/estudiante/inicio.html':
            ...
            obtenerTodosAsistenciaLEstudiante();
            break;
        default:
...
function verificarUsuario(){
    ...
    itemasistencia = document.getElementById("item-Asistencia");
    if(token != null){
        if(token.id_rol=="1" && token.id_estado=="1"){
            ...
            itemasistencia.style.display="block";
            ...
            itemasistencia.style.display="none";
            itemCerrarSession.style.display="block";
            Swal.fire({
                position: 'top-end',
                icon: 'error',
