    ...
    function init() {
        var router = new Router([
            ...
            new Route('EstadUpdate', 'estado/estadoadmin.html'),
             //asistencia
             new Route('asistenciaadmi', 'asistencia/asistencialistado.html'),
             new Route('crearAsistenciaAdmi', 'asistencia/asistenciacrear.html'),
            //Informacion Usuario Login
            new Route('InfoUser','infoUser.html'),
            //LOGIN
            new Route('login', 'acceso.html'),
            //recuperacion de Pass
            new Route('cambioclave', 'cambioclave.html'),
            // componente de pagos
